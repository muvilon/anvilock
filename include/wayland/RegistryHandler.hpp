...
// Registry handler
inline void handleRegistryGlobal(ClientState& cs, anvlk::types::wayland::WLRegistry_* registry,
...
inline void handleRegistryRemove(ClientState& cs, u32 name)
{
...
inline constexpr static wl_registry_listener kRegistryListener = {
  ...
  .global = [](types::VPtr data, types::wayland::WLRegistry_* registry, u32 name,
               const char* interface, u32 version)
  { handleRegistryGlobal(*static_cast<ClientState*>(data), registry, name, interface, version); },
  .global_remove = [](types::VPtr data, types::wayland::WLRegistry_*, u32 name)
